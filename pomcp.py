...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_epochs', default=14, type=int, help='Num of epochs of the experiment to conduct')
    ...
    parser.add_argument('--DRLType', default="IS_A2CModel", type=str, help='a method for action selection')
    parser.add_argument('--MaxNumIterationForBeliefNode', default=30, type=int, help='a method for action selection') # optimal : 30
